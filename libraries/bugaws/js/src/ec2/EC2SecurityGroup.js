...
//@Export('bugaws.EC2SecurityGroup')

//@Require('Class')
//@Require('Set')
//@Require('bugaws.AwsObject')
//@Require('bugaws.EC2IpPermission')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var EC2IpPermission     = bugpack.require('bugaws.EC2IpPermission');
    ...
    bugpack.export('bugaws.EC2SecurityGroup', EC2SecurityGroup);
});
